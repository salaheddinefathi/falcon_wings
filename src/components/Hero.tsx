        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-4 w-full max-w-none mx-auto sm:mx-0">
              <a
                href="#products"
                className="inline-flex items-center justify-center gap-2 flex-1 bg-falcon-blue text-white px-8 py-4 rounded-full text-base font-bold transition-all duration-300 hover:bg-falcon-blue/90 hover:shadow-lg hover:shadow-falcon-blue/25"
              >
                Explore Products
                <svg
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 flex-1 border-2 border-white/30 text-white px-8 py-4 rounded-full text-base font-semibold transition-all duration-300 hover:border-falcon-blue hover:text-falcon-blue"
              >
