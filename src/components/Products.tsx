            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-sky-400 text-[#071426] px-6 py-3 rounded-full text-sm font-bold transition-all duration-300 hover:bg-sky-400/90 hover:shadow-lg hover:shadow-sky-400/25 w-full"
                >
