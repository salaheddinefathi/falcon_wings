            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-falcon-blue text-white px-6 py-3 rounded-full text-sm font-bold transition-all duration-300 hover:bg-falcon-blue/90 hover:shadow-lg hover:shadow-falcon-blue/25 w-full"
                >
