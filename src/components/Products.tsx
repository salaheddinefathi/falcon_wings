            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-orange-400 text-falcon-navy px-6 py-3 rounded-full text-sm font-bold transition-all duration-300 hover:bg-orange-400/90 hover:shadow-lg hover:shadow-orange-400/25 w-full"
                >
